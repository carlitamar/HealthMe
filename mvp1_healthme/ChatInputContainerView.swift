...
//    weak var chatLogController: ChatbotController? {
//        didSet {
//            sendButton.addTarget(chatbotController, action: #selector(ChatbotController.handleSend), for: .touchUpInside)
//            uploadImageView.addGestureRecognizer(UITapGestureRecognizer(target: chatbotController, action: #selector(ChatbotController.handleUploadTap)))
//        }
//    }
