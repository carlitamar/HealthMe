...
//  mvp1_healthme
//
//  Created by Carla on 16-06-20.
//  Copyright © 2020 healthme. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        //replacing what the storyboard uses
        //this does it manually when you dont want to use storyboards
        ...
        identityPoolId:"us-east-1:a8d17863-36b0-4052-9e46-d6f181346664")
